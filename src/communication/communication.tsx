...
MCourserCommunication.prototype.requestCollectionData = function(id) {
    ...
    this._sendEvent(this.EVENTS_MAP.REQUEST_COLLECTION_DATA, {
        id: id
    })
...
MCourserCommunication.prototype.requestCollectionDataWithFlags = function(id) {
    ...
    this._sendEvent(this.EVENTS_MAP.REQUEST_COLLECTION_DATA_WITH_FLAGS, {
        id: id
    })
...
MCourserCommunication.prototype.requestCollectionLessonsPaginatedResults = function(id) {
    ...
    this._sendEvent(this.EVENTS_MAP.REQUEST_COLLECTION_LESSONS_PAGINATED_RESULTS_DATA, {
        id: id
    })
...
MCourserCommunication.prototype.requestCollectionCustomTOCFirstVisitDate = function(id) {
    ...
    this._sendEvent(this.EVENTS_MAP.REQUEST_COLLECTION_CUSTOM_TOC_FIRST_VISIT_DATE_DATA, {
        id: id
    })
...
MCourserCommunication.prototype.postCollectionCustomTOCFirstVisitDate = function(id) {
    ...
    this._sendEvent(this.EVENTS_MAP.POST_COLLECTION_CUSTOM_TOC_FIRST_VISIT_DATE_DATA, {
        id: id
    })
    return this._connectIntoEvent(this.EVENTS_MAP.COLLECTION_CUSTOM_TOC_FIRST_VISIT_DATE_DATA,
        function(collectionCustomTOCFirstVisitDate) {
...
MCourserCommunication.prototype.requestCollectionCustomTOCAndAnyLessonLastVisitsDates = function(id) {
    ...
    this._sendEvent(this.EVENTS_MAP.REQUEST_COLLECTION_CUSTOM_TOC_AND_ANY_LESSON_LAST_VISITS_DATES_DATA, {
        id: id
    })
...
MCourserCommunication.prototype.postCollectionCustomTOCLastVisitDate = function(id) {
    ...
    this._sendEvent(this.EVENTS_MAP.POST_COLLECTION_CUSTOM_TOC_LAST_VISIT_DATE_DATA, {
        id: id
    })
    return this._connectIntoEvent(this.EVENTS_MAP.COLLECTION_CUSTOM_TOC_AND_ANY_LESSON_LAST_VISITS_DATES_DATA,
        function(collectionCustomTOCAndAnyLessonLastVisitsDates) {
...
MCourserCommunication.prototype.requestCollectionCustomTOCState = function(id, state) {
    ...
    this._sendEvent(this.EVENTS_MAP.REQUEST_COLLECTION_CUSTOM_TOC_STATE_DATA, {
        id: id,
        state: state
    })
...
MCourserCommunication.prototype.postCollectionCustomTOCState = function(id, state) {
    ...
    this._sendEvent(this.EVENTS_MAP.POST_COLLECTION_CUSTOM_TOC_STATE_DATA, {
        id: id,
        state: state
    })
    return this._connectIntoEvent(this.EVENTS_MAP.COLLECTION_CUSTOM_TOC_STATE_DATA,
...
MCourserCommunication.prototype.requestCollectionCodeActionAndMarket = function(id) {
    ...
    this._sendEvent(this.EVENTS_MAP.REQUEST_COLLECTION_CODE_ACTION_AND_MARKET, {
        id: id
    })
...
MCourserCommunication.prototype._connectIntoEvent = function(type, matchEvent) {
    ...
    var event = {
        ...
        matchEvent: matchEvent || function() {
            return true
        } // In case if we want to match specific ID or different field
    };
